...
nrays_values = [5000, 10000, 25000, 50000, 100000, 150000]

for i, nrays in enumerate(nrays_values):
    data["basic_config"]["nphot"] = nrays
    with open(f"opt_config_{i}.json", "w") as f:
        json.dump(data, f, indent=2)
    print(f"Config {i}: nrays={nrays}, n_events=500")
